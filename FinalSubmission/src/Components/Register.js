...
function Register()
{
    ...
    const doRegister = async event => 
    {
        ...
        var obj = {username:registerUsername.value, password:registerPassword.value, email: registerEmail.value, userType: registerUserType.value};
        ...
        <div class='wrapper-register d-flex align-items-center justify-content-center'>
            <div class='container align-items-center justify-content-center' id="registerDiv">
                <form onSubmit={doRegister}>
                    ...
                    <center><input type="text" id="registerUserType" placeholder="User Type" ref={(c) => registerUserType =c}/><br /></center>
